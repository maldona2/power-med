...
- Keep numeric prefixes sorted by context priority:
  ...
  - `30-39`: backend code rules (framework core first, then framework packages, then ORM, then other backend libraries).
  - `40-49`: frontend code rules (language first, then framework core, then framework ecosystem libraries, then styling rules).
